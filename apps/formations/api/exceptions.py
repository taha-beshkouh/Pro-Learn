...
class ProjectReadinessConflict(APIException):
    status_code = 409
    default_detail = "Project readiness conflicts with current participation state."
    default_code = "project_readiness_conflict"
